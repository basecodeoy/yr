...
final class Response extends Data
{
    ...
    public static function fromResponse(array $data): self
    {
        return new self(
            ...
            initialStates: collect($data['initialStates'])->map(fn (array $value): \BaseCodeOy\Yr\Location\Data\CelestialEvents\InitialState => InitialState::fromResponse($value)),
            events: collect($data['events'])->map(fn (array $value): \BaseCodeOy\Yr\Location\Data\CelestialEvents\Event => Event::fromResponse($value)),
